            ...
            <div title="${role.id}" class="${classOfContentOfRole}">
                ...
                <div class="content-section">
                    <group id="group-of-details">
                        <a id="${role.id}-responsibilities" class="detail-category" href="#" onclick="selectRoleDetail(this.id)">Responsibilities</a>
                    ...
                    <div id="tab-content-responsibilities" title="${role.id}-responsibilities" class="tab-content">
